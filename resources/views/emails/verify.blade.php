    ...
    <div class="wrapper">
        <div class="container">
            ...
            <p>
                ...
                cliquez sur le bouton ci-dessous afin de vérifier votre adresse email.
            </p>
            <a href="{{ $verificationUrl }}" class="btn">✅ Vérifier mon compte</a>
            <p style="margin-top: 30px;">Si vous n'avez pas créé de compte, vous pouvez ignorer cet email.</p>
            <div class="footer">
                © {{ date('Y') }} SmartOrderIA. Tous droits réservés.
            </div>
        </div>
    </div>
</body>
